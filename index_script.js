const canvas = document.getElementById('heart');
        ...
        // Текст твоей песни
        const lyrics = "Мама, спасибо тебе. За завтраки, за терпение, за тёплые руки и мудрые советы. За то, что слушаешь и слышишь. За то, что ты есть. Ты делаешь нашу жизнь полной. Мы благодарны тебе каждый день.".split(' ');
