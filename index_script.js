const canvas = document.getElementById('heart');
        ...
        // Текст твоей песни
        const lyrics = "Самая лучшая и красивая мама в мире, поздравляю тебя с 8 Марта! Спасибо тебе за твою заботу, ласку и бесконечную любовь. Желаю тебе крепкого здоровья, бодрости духа и чтобы каждый твой день был согрет теплом и вниманием близких. Ты — моя опора и радость!".split(' ');
